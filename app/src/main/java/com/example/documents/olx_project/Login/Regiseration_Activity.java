package com.example.documents.olx_project.Login;
...
import com.example.documents.olx_project.R;
...
public class Regiseration_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regiseration_);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>(){
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()){
                            Toast.makeText(Regiseration_Activity.this, "Authentication failed.",
                        ...
                        if (task.isSuccessful()){
                            userProfile();
                            Toast.makeText(Regiseration_Activity.this, "Created Account", Toast.LENGTH_SHORT).show();
